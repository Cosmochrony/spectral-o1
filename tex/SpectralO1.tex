...
% -- metadata ------------------------------------------------------------------
\title{Projective Resolution Dynamics\\
on Variable-Valence Relaxation Graphs}
...
% ------------------------------------------------------------------------------
    ...
    \subsection{Context and motivation}
      ...
      The admissibility sub-programme of the Bounded Admissibility Theory
      (BAT)~\cite{cosmochrony} aims to derive the number and mass hierarchy of
      ...
      establishing one structural layer: spectral admissibility~\cite{admissibility},
      spectral capacity~\cite{capacity}, Gram rigidity~\cite{rigidity}, spectral
      stratigraphy~\cite{stratigraphy}, and asymptotic saturation~\cite{relaxation}.

      The paper~\cite{stratigraphy} establishes that the representation-theoretic
      ...
      separation.
      The paper~\cite{relaxation} analyses this second question.
      ...
      However, \cite{relaxation} also identifies two structural limitations of the
  ...
  This corrects the effective mass ordering inversion of~\cite{relaxation}
  by a geometric mechanism.
    ...
    \subsection{What this paper does not prove}
      ...
      (cf.~\cite{relaxation}, Section~6.5).
      ...
      from~\cite{stratigraphy} and is left open here.
    ...
    \subsection{Organisation}
      ...
      Section~\ref{sec:saturation} summarises what~\cite{relaxation} established and
      ...
      Section~\ref{sec:physical} provides the physical interpretation in the BAT
      framework.
...
% ------------------------------------------------------------------------------
    ...
    All notation follows~\cite{relaxation}.
    ...
    \subsection{Projective resolution}
      ...
      Following~\cite{relaxation}, the \emph{projective resolution threshold}
    ...
    \subsection{ADE eigenvalue levels}
      ...
      by the ADE binary groups~\cite{stratigraphy}.
...
% ------------------------------------------------------------------------------
    ...
    We summarise the results of~\cite{relaxation} that motivate the present paper.
  ...
  constant}: the relaxation cascade reaches a spectrally stationary regime.
    ...
    \subsection{Two structural limitations}
      ...
      concrete limitations established in~\cite{relaxation}.
      ...
      \paragraph{Effective mass ordering inversion.}
        ...
        the admissibility envelope of~\cite{stratigraphy}.

      \paragraph{Amplitude problem.}
        The predicted effective mass ratios at fixed $p$ lie in $[0.10,\, 2.2]$,
        far above the observed lepton hierarchy $10^{-3}$--$10^{-5}$~\cite{relaxation}.
...
% ------------------------------------------------------------------------------
  ...
  \subsection{Kesten--McKay contraction}
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.82\textwidth]{O1_fig2_KM_width}
  ...
  \subsection{Ordered exit of ADE levels}
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.88\textwidth]{O1_fig1_KM_contraction}
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.82\textwidth]{O1_fig3_stab_ranks}
  ...
  In the BAT framework, $p(n) \to \infty$ corresponds to an increase of the
...
% ------------------------------------------------------------------------------
  ...
  \subsection{Effective mass ordering}
    ...
    principle of~\cite{stratigraphy,relaxation}.
  ...
  \subsection{Correction of the fixed-valence inversion}
    ...
    Under the fixed-valence saturation mechanism of~\cite{relaxation}, the
...
% ------------------------------------------------------------------------------
  ...
  \subsection{What the variable-valence mechanism provides}
    ...
    In the fixed-valence regime, the effective mass ratio was~\cite{relaxation}:
    \begin{equation}
      \frac{M_i}{M_j} \;=\;
...
% ------------------------------------------------------------------------------
  \section{Physical Interpretation in the BAT Framework}
  \label{sec:physical}
% ------------------------------------------------------------------------------
  ...
  \subsection{Relational valence and the cascade}
    ...
    In the BAT framework~\cite{cosmochrony}, the relaxation graph $G_n$ encodes
  ...
  \subsection{Support contraction as spectral stratification}
    ...
    of~\cite{relaxation}, where all three levels remained simultaneously inside
    ...
    and cumulative-mass ordering~\cite{relaxation} coexist in the full cascade,
  ...
  \subsection{Minimal structural requirement}
    ...
    \begin{enumerate}
      ...
      admissibility framework of~\cite{admissibility} remains valid;
...
% ------------------------------------------------------------------------------
  ...
  This paper revisits the saturation mechanism identified in~\cite{relaxation}
  ...
  \subsection{Summary of results}
    ...
    the exit order, correcting the inversion $M_1 < M_2 < M_3$ of~\cite{relaxation}
    by a geometric mechanism requiring no additional dynamical hypothesis.

    These three results establish that:
    \begin{enumerate}
      \item[(i)] the fixed-valence saturation plateau of~\cite{relaxation} is an
  ...
  \subsection{Open directions}
    ...
    \paragraph{Amplitude problem.}
      ...
      relation of direction (O3) of~\cite{relaxation}.
    ...
    \paragraph{Level-to-generation map.}
      ...
      correspondence from the construction of~\cite{stratigraphy}.
...
% ------------------------------------------------------------------------------
      ...
      \begin{thebibliography}{99}
        ...
        Zenodo (2026).
        \newblock DOI: [to be inserted upon finalisation].

        \bibitem{stratigraphy}
        J.~Beau,
        ...
        \bibitem{relaxation}
        J.~Beau,
        ``Asymptotic Saturation of Projective Resolution: Expander Relaxation
        Graphs,''
        Zenodo (2026).
        \newblock DOI: [to be inserted upon publication].

        \bibitem{LPS}
        A.~Lubotzky, R.~Phillips, and P.~Sarnak,
        ``Ramanujan graphs,''
        \textit{Combinatorica} \textbf{8}, 261--277 (1988).

        \bibitem{McKay}
        B.~D. McKay,
        ``The expected eigenvalue distribution of a large regular graph,''
        \textit{Linear Algebra Appl.} \textbf{40}, 203--216 (1981).

        \bibitem{Kesten}
        H.~Kesten,
        ``Symmetric random walks on groups,''
        \textit{Trans.\ Amer.\ Math.\ Soc.} \textbf{92}, 336--354 (1959).
