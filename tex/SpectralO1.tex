...
spectral stratigraphy, mass hierarchy
  ...
  \subsection{Kesten--McKay contraction}
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.82\textwidth]{O1_fig2_KM_width.pdf}
  ...
  \subsection{Ordered exit of ADE levels}
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.88\textwidth]{O1_fig1_KM_contraction.pdf}
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.82\textwidth]{O1_fig3_stab_ranks.pdf}
